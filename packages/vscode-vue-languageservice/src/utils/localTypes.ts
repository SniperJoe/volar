...
export type UnwrapInstanceType<T> = T extends new (...args: any) => any ? { [ K in keyof InstanceType<T>] : InstanceType<T>[K] } : T;
export type ClassComponentContext<T, R> = R extends new (...args: any) => any ? UnwrapInstanceType<T> & UnwrapInstanceType<R> : InstanceType<T>;
export type ComponentContext<T, R> = T extends new (...args: any) => any ? ClassComponentContext<T, R> : T extends (...args: any) => any ? ReturnType<T> : T;
